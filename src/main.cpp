        ...
        if (event == "telemetry") {
          ...
          // j[1] is the data JSON object
            ...
            if (too_close){
          	...
          	vector <double> next_wp0 = getXY(car_s + 30, 0.5 * lane_width + lane_width * lane, map_waypoints_s, map_waypoints_x, map_waypoints_y);
          	vector <double> next_wp1 = getXY(car_s + 60, 0.5 * lane_width + lane_width * lane, map_waypoints_s, map_waypoints_x, map_waypoints_y);
          	vector <double> next_wp2 = getXY(car_s + 90, 0.5 * lane_width + lane_width * lane, map_waypoints_s, map_waypoints_x, map_waypoints_y);
